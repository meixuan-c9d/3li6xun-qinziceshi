<template>
  <aside class="guideSelect">
    <span 
      ref="icon"
      class="guideSelect__icon"
    >
    ...
    <span class="guideSelect__text">点击人物选择</span>
  </aside>
</template>
...
export default {
  mounted() {
    const timelineIcon = gsap.timeline({
      yoyo: true,
      repeat: -1
    })
    timelineIcon
    ...
    .to(this.$refs.icon, .35, {
      autoAlpha: 1
    })
    timelineIcon.timeScale(.5)
  }  
}
</script>
